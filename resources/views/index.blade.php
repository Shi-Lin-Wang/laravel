...
<html lang="en">
  ...
  <body onload="index()">
    <div class="container">
      <form class="form-signin" action="http://localhost:8001/login" method="POST">
        ...
        <div class="form-div">
          ...
          <input type="button" class="btn btn-lg btn-primary btn-block " value="Sign up" onclick=" window.location = 'http://localhost:8001/signup'"></input>
        </div>
